with model_defaults(model_id, modes) as (
  values
    ('happyhorse-1.1', '{"text_to_video":"happyhorse-1-1-t2v","start_frame":"happyhorse-1-1-i2v","multi_image_reference":"happyhorse-1-1-r2v"}'::jsonb),
    ('happyhorse-1.0', '{"text_to_video":"happyhorse-1-0-t2v","start_frame":"happyhorse-1-0-i2v","multi_image_reference":"happyhorse-1-0-r2v","video_edit":"happyhorse-1-0-video-edit"}'::jsonb)
),
global_settings as (
  select
    ...
    coalesce(
      ...
      nullif(video_workspace #>> '{models,happyhorse-1.0,apiKey}', ''),
