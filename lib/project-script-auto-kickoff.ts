 ...
 */
export const PROJECT_SCRIPT_AUTO_STAGE1_USER_MESSAGE = [
...
export const PROJECT_SCRIPT_AUTO_STAGE_USER_MESSAGE: Record<1 | 2 | 3 | 4 | 5 | 6 | 7, string> = {
  1: PROJECT_SCRIPT_AUTO_STAGE1_USER_MESSAGE,
  2: [
...
export function getProjectScriptAutoStageUserMessage(stage: number): string | undefined {
  if (stage < 1 || stage > 7) return undefined;
  return PROJECT_SCRIPT_AUTO_STAGE_USER_MESSAGE[stage as 1 | 2 | 3 | 4 | 5 | 6 | 7];
}
